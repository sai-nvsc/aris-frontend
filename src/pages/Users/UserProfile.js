      ...
      <Container maxWidth="xl">
                ...
                <Box display={"flex"} justifyContent="center">
                  ...
                  >
                    ...
                    >
                      ...
                      <Grid xs={6}>
                        <PetProfileValue>
                          <StyledLink to="/user/mypets">
                            Pets:{" "}
                            <b>{user_analytics ? user_analytics.pet : 0}</b>
                          </StyledLink>
                        </PetProfileValue>
                      </Grid>
                    </Grid>
        ...
        <Grid container sx={{ display: " flex", flexDirection: "row" }}>
          <Grid item xs={12} sm={12} md={12} lg={6}>
            <Container component="main" sx={{ mt: 6, mb: 2 }}>
              <ProfileCard>
                <CardContent>
          ...
          <Grid item xs={12} sm={12} md={12} lg={6}>
            <Container component="main" sx={{ mt: 6, mb: 2 }}>
              <ProfileCard>
                ...
                <CardContent>
                  <CardHeader />
                  <Typography variant="h5" marginBottom={3} align="center">
